...
-(void)drawEyeWithEye:(CBDEye *)eye{
    ...
    GLKMatrix4 modelViewMatrix= GLKMatrix4Multiply(eye.eyeViewMatrix,GLKMatrix4MakeTranslation(0, 0, 1.5));
    GLKMatrix4 projectionMatrix = [eye perspectiveMatrixWithZNear:0.0001 zFar:10000];
...
- (void)didReceiveMemoryWarning
{
    ...
    if ([self isViewLoaded] && ([[self view] window] == nil)) {
        ...
        if ([EAGLContext currentContext] == self.view.context) {
